...
best_param_RF_10 = best_trials[max_index].params

model_RF_10 = RandomForestClassifier(random_state=42)
model_RF_10.set_params(**best_param_RF_10)

joblib_file = "Classifiers/Optuna_model_RF_10.pkl"
joblib.dump(model_RF_10, joblib_file)